...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-30 fw-bold text-uppercase text-purple">APPROVED OTHER GRADE REQUESTS
      ...
      <div class="col-12">
         ...
         <div class="col-12">
            ...
            <div class="table-responsive">
                <table id="otherGradeTable" class="table table-striped table-hover table-bordered">
