...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-30 fw-bold text-uppercase text-purple">SCHOLARSHIP DETAILS
         </h1>
      </div>
      ...
      <div class="col-12">
         ...
         <div class="row ">
            <div class="col-lg-9 col-sm-12 pb-3">
               <div class="row">
                  <div class="col-lg-3 col-sm-4 col-12  pb-sm-3 pb-3">
                     <ul class="d-flex">
                        <li>
                  ...
                  <div class="col-lg-3 col-sm-4 col-12  pb-sm-3 pb-3">
                     <ul class="d-flex">
                        <li>
                           <span
                              class=" font-12 fw-bolder text-white mt-2 bg-info py-1 px-3  rounded-3">  FREE CARD COUNT
                           </span>
                        </li>
                        <li>
                  ...
                  <div class="col-lg-3 col-sm-4 col-12  pb-sm-3 pb-3">
                     <ul class="d-flex">
                        <li>
                           <span
                              class=" font-12 fw-bolder text-white mt-2 bg-info py-1 px-3  rounded-3">  HALF CARD COUNT
                           </span>
                        </li>
                        <li>
                  ...
                  <div class="col-lg-3 col-sm-4 col-12  pb-sm-3 pb-3">
                     <ul class="d-flex">
                        <li>
                           <span
                              class=" font-12 fw-bolder text-white mt-2 bg-info py-1 px-3  rounded-3"> QUARTER CARD COUNT
                           </span>
                        </li>
                        <li>
         ...
         <div class="col-12">
            ...
            <div class="table-responsive">
                <table id="schoolshipTable" class="table table-striped table-hover table-bordered">
